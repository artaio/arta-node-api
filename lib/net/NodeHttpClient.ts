...
function initParams (params?: Partial<HttpRequestParameters>): HttpRequestParameters {
  const defaultParams = {
...
export class NodeHttpClient implements HttpClient {
  ...
  async request (host: string, params?: Partial<HttpRequestParameters>): Promise<HttpClientResponse> {
    const {
      protocol,
      port,
      path,
    ...
    const requestPromise: Promise<HttpClientResponse> = new Promise((resolve, reject) => {
